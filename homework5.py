...
dir_name = "/Users/Николай/Documents/GitHub/python1"
files = []
...
book1 = Workbook()
page1 = book1.active
for row in range(0, len(new_arr)):
    for col in range(0, len(new_arr[row])):
        page1.cell(row=row + 1, column=col + 1).value = new_arr[row][col]
book1.save("homework_5.xlsx")